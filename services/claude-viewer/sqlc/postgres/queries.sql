...
SELECT connector_name FROM connector_roles WHERE role = $1 LIMIT 1;
...
DELETE FROM connector_roles WHERE role = $1;
...
SELECT * FROM plan_comments WHERE plan_id = $1 ORDER BY created_at ASC;
