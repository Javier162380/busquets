...
13. **Keep Schemas in sync**- Migrations schemas for directories internal/storage/migrations/* and services/claude-viewer/sqlc needs to be always in sync please. 