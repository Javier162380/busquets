...
func TestClipboard(t *testing.T) {
	t.Run("effectiveMode", func(t *testing.T) {
	...
	t.Run("osc52MaxEncodedLen", func(t *testing.T) {
		uu := map[string]struct {
			env string
			e   int
		}{
	...
	t.Run("osc52Sequence", func(t *testing.T) {
	...
	t.Run("write empty is a no-op", func(t *testing.T) {
		require.NoError(t, SystemClipboard{}.Write("", ModeNative))
		require.NoError(t, SystemClipboard{}.Write("", ModeOSC52))
	})

	t.Run("writeOSC52 reports unavailable off a tty", func(t *testing.T) {
